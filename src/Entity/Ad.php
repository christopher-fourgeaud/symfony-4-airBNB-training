...
class Ad
{
     ...
     * @ORM\Column(type="string", length=255)
     * @Assert\Url(
     *    message = "L'url donnée n'est pas une url valide !",
     * )
     */
    private $coverImage;
    ...
    public function getAvgRatings(){
        ...
        // Faire la division pout avoir la moyenne
     ...
     *
     * @return array Un tableau d'objets DateTime représentants les jours d'occupation
     */
