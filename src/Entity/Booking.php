...
class Booking
{
    ...
    /**
     * Permet d'initialiser la date de création du booking et de
     * set le prix de celui ci en fonction de la durée du séjour
     *
     * @ORM\PrePersist()
     * @ORM\PreUpdate()
     * 
    ...
    /**
     * Permet de calculer la durée du séjour booké
     *
     * @return int
     */
